 ...
 * @author aliazhar
 */
public class LaundryCreateView extends javax.swing.JFrame {

    /**
     * Creates new form LaundryCreateView
     */
    public LaundryCreateView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaundryCreateView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaundryCreateView().setVisible(true);
            }
        });
    }
