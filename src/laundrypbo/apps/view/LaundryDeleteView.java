 ...
 * @author aliazhar
 */
public class LaundryDeleteView extends javax.swing.JFrame {

    /**
     * Creates new form LaundryDeleteView
     */
    public LaundryDeleteView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaundryDeleteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaundryDeleteView().setVisible(true);
            }
        });
    }
